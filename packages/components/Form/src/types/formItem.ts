...
export type FormItem = {
   ...
   * It is similar to help. Usage example: to display error message and prompt message at the same time.
  ...
  /**
   * The layout of label.
   * You can set span offset to something like {span: 3, offset: 12} or sm: {span: 3, offset: 12} same as with <Col>
   * @type Col
   */
